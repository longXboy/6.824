...
func TestInitialElection2A(t *testing.T) {
	...
	if term1 != term2 {
		fmt.Printf("warning: term(%d to %d) changed even though there were no failures\n", term1, term2)
	}
...
func TestFailAgree2B(t *testing.T) {
	...
	fmt.Println("disconnect server:", (leader+1)%servers)
...
func TestRejoin2B(t *testing.T) {
	...
	fmt.Println("send 104")
	cfg.one(104, 2)
	fmt.Println("all together now")
	// all together now
	cfg.connect(leader2)

	fmt.Println("checkout 105")
	cfg.one(105, servers)
